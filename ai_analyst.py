...
- Все рекомендации должны иметь обоснование с данными
- Указывай ожидаемый результат конкретными цифрами
- Если данных недостаточно — говори об этом честно

ОТРАСЛЕВЫЕ БЕНЧМАРКИ (appliance repair, USA):
- Хороший CTR: 4-8%
