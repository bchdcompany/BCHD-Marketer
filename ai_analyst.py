...
3. data_needed — СПИСОК типов данных, нужных для полного ответа (можно
   ...
   списания, категории услуг не по профилю), seasonal (сезонные
...
"""
    ...
    async def analyze_lsa_call(self, transcript: str, lead_metadata: dict) -> dict:
        ...
        prompt = f"""
Бизнес: ремонт бытовой техники (appliance repair) в Нью-Йорке —
холодильники, стиральные машины, сушилки, посудомоечные машины, плиты,
духовки, микроволновки. НЕ обслуживает: телевизоры, кофемашины, пылесосы,
фены и прочую мелкую бытовую электронику.
